...
def menuTakeItem():
    ...
    if clientArgs["code"] > len(catalog):
        ...
        return
    print('there are',catalog[clientArgs['code']]['quantity'],'in our inventory')
...
def menuReturnItem(): #untested
    ...
    try:
        if clientInput[0] == 'c':
            ...
            print('all', cart[clientArgs['code']]['product'],'have been returned to the shop.')
            clientArgs['quantity'] = cart[clientArgs['code']]['quantity']
        elif int(clientInput) > cart[clientArgs['code']]['quantity']: # if requestNum > num in cart
            print('all', cart[clientArgs['code']]['product'],'have been returned to the shop.')
            clientArgs['quantity'] = cart[clientArgs['code']]['quantity']
    except:
